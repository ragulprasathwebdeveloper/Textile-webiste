...
const Stitch=()=>{
    ...
    <div className='aboutpagemain'>
        ...
        <div className='aboutusbannerlink'>
          ...
          <Link to="/" className='aboutusbanneraboutlink'>Stitch Fabric</Link>
        </div>
        </div>
...
<div>
    <div className='fabrictotal fade-left'>
     <div>
      <Link to="/FabricDyeing" className='sd1 Stitchleft2' >Fabric Dyeing </Link>
      <Link to="/Manufacture" className="sd1 Stitchleft1" > Manufacture</Link>
      <Link to="/Stitch" className="Stitchleft3" >Stitch Fabric</Link>
    </div>    
    </div>
...
<img src={company} className='texticaimg'/>
  ...
  <div className='texticaservicestext'>
    ...
    <p> <a href="/FabricDyeing" style={{ textDecoration: 'none', color: 'inherit' }}> Our Services </a> </p>
