...
const Fabric1=()=>{
    ...
    <div className='aboutusbannerlink'>
      ...
      <Link to="/" className='aboutusbanneraboutlink'>Fabric Dyeing</Link>
    </div>
...
<div>
    <div className='fabrictotal fade-left'>
     <div>
          <Link to="/FabricDyeing" className='fabricleft2' >Fabric Dyeing </Link>
          <Link to="/Manufacture" className="fd1 fabricleft1" > Manufacture</Link>
          <Link to="/Stitch" className="fd1 fabricleft3" >Stitch Fabric</Link>
        </div>   
    </div>
...
<div>
    ...
    <div className='fabricfinalflex fade-right'>
...
<img src={company} className='texticaimg'/>
  ...
  <p> <a href="/FabricDyeing" style={{ textDecoration: 'none', color: 'inherit' }}  > Fabric Printing </a> </p>
  <p> <a href="/Stitch" style={{ textDecoration: 'none', color: 'inherit' }} >Stitch Fabric </a> </p>
  <p> <a href="/Manufacture" style={{ textDecoration: 'none', color: 'inherit' }}  > Manufacture </a> </p>
</div>
  ...
  <div className='texticaservicestext'>
    <p> <a href="/aboutus" style={{ textDecoration: 'none', color: 'inherit' }} > About Us </a> </p>
    <p> <a href="/Ourservices" style={{ textDecoration: 'none', color: 'inherit' }}> Our Services </a> </p>
    <p> <a href="/Ourteam" style={{ textDecoration: 'none', color: 'inherit' }} > Our Team </a> </p>
    <p> <a href="/ShopCart" style={{ textDecoration: 'none', color: 'inherit' }} > Our Pricing </a> </p>
  </div>
</div>
...
<div className='texticaiconsline'>      
  {/* Social Icon Links */}
      {[
        ...
        <a key={index} href={social.link} target="_blank" rel="noopener noreferrer" className='texticaicons'
          onMouseEnter={(e) => {
